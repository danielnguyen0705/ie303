        ...
        if (nextUnits.length > 0) {
          ...
          setForm((prev) => {
            return {
              ...prev,
              unitNumber:
                nextUnits.some((unit) => unit.unitNumber === prev.unitNumber)
                  ? prev.unitNumber
                  : firstUnitNumber,
            };
          });
    ...
    if (response.success && response.data) {
      ...
      popup.error({
        ...
        message:
          ...
          "Could not generate questions. You may need some wrong-answer history in this unit first.",
      });
    }
    ...
    <main className="max-w-7xl mx-auto px-6 py-10 space-y-8 pb-24 md:pb-12">
      <section className="space-y-3">
        ...
        <p className="text-gray-600 font-medium">
          Generate a fresh practice set by grade and unit.
        </p>
      </section>
          ...
          {loadingGrades ? (
            ...
            <>
              ...
              <div className="rounded-2xl border border-[#dbeafe] bg-[#f8fbff] p-4 text-sm text-[#1e2e51]">
                ...
                unit, the backend can return no personalized set.
              </div>
