...
export const units: Unit[] = [
  // Học kỳ 1
  {
    ...
    title: "Family Life",
    description:
      "Learn vocabulary and grammar related to family relationships and daily activities",
    icon: "family_history",
    progress: 100,
    status: "completed",
    colorScheme: "primary",
  ...
  },
  {
    ...
    description:
      "Explore topics about health, fitness, and maintaining a healthy lifestyle",
    icon: "vital_signs",
    progress: 65,
    status: "in-progress",
  ...
  },
  {
    ...
    title: "Music",
    description:
      "Discover the world of music, instruments, and musical expressions",
    icon: "music_note",
    progress: 25,
    status: "upcoming",
  ...
  },
  {
    ...
    description:
      "Focus on environmental conservation and protection strategies",
    icon: "cloud_sync",
    progress: 0,
    status: "locked",
    colorScheme: "tertiary",
...
export const questionBank: Question[] = [
  // Grammar Questions
  {
    ...
    explanation:
      'We use Present Simple (washes) for habits and routines. The time expression "every evening" indicates a regular action.',
    points: 10,
  },
  {
    id: "q-002",
    ...
    difficulty: "advanced",
    question:
      "By the time the professor arrived, the students _____ the experimental setup for twenty minutes.",
    options: [
      "had been preparing",
      "were preparing",
      "have prepared",
    ...
    explanation:
      'Although the action of preparing occurred before the professor arrived, this sentence emphasizes an ongoing action at a specific moment in the past. "By the time" + Simple Past can be used with Past Continuous if emphasizing the ongoing nature of the action.',
    points: 15,
  },
  // Vocabulary Questions
  {
    ...
    difficulty: "easy",
    question:
      "A person who takes care of sick people in a hospital is called a _____.",
    options: ["teacher", "nurse", "engineer", "chef"],
    correctAnswer: "nurse",
    explanation:
      "A nurse is a healthcare professional who provides medical care to patients in hospitals and clinics.",
    points: 5,
  },
  {
    id: "q-004",
    ...
    difficulty: "medium",
    question:
      "The concert was _____ - everyone enjoyed the amazing performance.",
    options: ["boring", "terrible", "fantastic", "awful"],
    correctAnswer: "fantastic",
    explanation:
      'The context "everyone enjoyed the amazing performance" indicates a positive adjective. "Fantastic" means extremely good or impressive.',
    points: 10,
  },
  // Reading Comprehension
  {
    ...
    difficulty: "medium",
    question:
      "The Comma butterfly has struggled to adapt to the warming climate in northern Britain.",
    correctAnswer: "FALSE",
    explanation:
      "According to the passage, generalist species like the Comma are thriving in the changing climate, not struggling.",
    points: 10,
  },
  {
    id: "q-006",
    ...
    difficulty: "medium",
    question:
      "Specialist butterflies are more vulnerable to habitat loss than generalist species.",
    correctAnswer: "TRUE",
    explanation:
      "The passage states that specialists such as the High Brown Fritillary are facing local extinctions due to habitat fragmentation.",
    points: 10,
  },
  // Listening Questions
  {
    ...
    explanation:
      'The audio mentions that longevity is "linked to" healthy lifestyle choices.',
    points: 10,
  },
];
...
Conservationists argue that creating "resilient landscapes" is the only path forward. This involves not just protecting existing nature reserves, but also restoring corridors of wild land that allow species to travel across an increasingly urbanised Britain. The success of the Large Blue reintroduction serves as a beacon of hope in an otherwise challenging era for British lepidoptera.`,
  questions: [
    ...
    },
    {
      ...
      number: 3,
      question:
        "The High Brown Fritillary is currently thriving in urbanised areas of London.",
      type: "true-false-not-given",
      correctAnswer: "FALSE",
      userAnswer: null,
      isCorrect: false,
    },
    {
      ...
      number: 4,
      question:
        "Spring emergence timing for butterflies is remaining constant despite global warming.",
      type: "true-false-not-given",
      correctAnswer: "FALSE",
      userAnswer: null,
      isCorrect: false,
