...
public class AIController {
    ...
    public ApiResponse<WritingEvaluationResponse> submitEssay(@RequestBody SubmitEssayRequest request) {
    ...
    public ApiResponse<WritingEvaluationResponse> submitEssayWithImage(@ModelAttribute SubmitEssayImageRequest request) {
        User user = userService.getCurrentUser();
    ...
    public ApiResponse<SpeakingEvaluationResponse> submitSpeaking(@ModelAttribute SubmitSpeakingRequest request) {
        User user = userService.getCurrentUser();
    ...
    public ApiResponse<java.util.List<com.ie303.uifive.dto.res.QuestionResponse>> generatePersonalizedQuestions(
            @RequestBody PersonalizedQuestionRequest request
    ) {
        return ApiResponse.<java.util.List<com.ie303.uifive.dto.res.QuestionResponse>>builder()
                .code(1000)
                .message("Generated personalized questions successfully")
                .result(personalizedPracticeService.generateFromWrongQuestions(request))
                .build();
    }
}
